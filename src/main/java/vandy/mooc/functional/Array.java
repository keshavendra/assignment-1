...
public class Array<E>
    ...
    public Array(Collection<? extends E> c) {
        // TODO -- you fill in here.
//        if (c != null && !c.isEmpty()) {
        mElementData = new Object[c.size()];
        System.arraycopy(c.toArray(), 0, mElementData, 0, mElementData.length);
...
//        }
    ...
    public int indexOf(Object o) {
        ...
        for (int i = 0; i < mSize; i++) {
            ...
            } else if (o.equals(mElementData[i])) {
                index = i;
                break;
            }
        }
    ...
    public boolean addAll(Array<E> array) {
        ...
        // System.arraycopy() instead and also call
        // ensureCapacityInternal() to simplify this code.
//        if (array != null && array.mElementData != null) {
        ensureCapacityInternal(array.mElementData.length + mSize);
        System.arraycopy(array.mElementData, 0, mElementData, mSize,
                array.mElementData.length);
        mSize += array.mElementData.length;
    ...
    protected void ensureCapacityInternal(int minCapacity) {
        ...
        if (mElementData == EMPTY_ELEMENTDATA) {
            if (minCapacity < DEFAULT_CAPACITY)
                ...
                mElementData = new Object[minCapacity];
        } else {
...
//                else
                ...
                System.arraycopy(mElementData, 0, temp, 0, mElementData.length);
                mElementData = temp;
            }
        }
    }
    ...
    public class ArrayIterator implements Iterator<E> {
        ...
        public boolean hasNext() {
            // TODO - you fill in here (replace 'return false' with
            // proper code).
            return mCurrentIndex < mCurrentSize;
        }
        ...
        public E next() {
            ...
            return (E) mElementData[mCurrentIndex++];
        }
        ...
        public void remove() {
            ...
            Array.this.remove(mCurrentIndex - 1);
            mCurrentIndex--;
            mCurrentSize--;
        }
    }
    ...
    public void replaceAll(UnaryOperator<E> operator) {
        ...
        for (int index = 0; index < mSize; index++) {
            mElementData[index] = operator.apply((E) mElementData[index]);
        }
        if (isEmpty())
            mElementData = EMPTY_ELEMENTDATA;
    }
    ...
    public void forEach(Consumer<? super E> action) {
        ...
        new ArrayIterator().forEachRemaining(action);
    }
    ...
    public List<E> asList() {
        ...
        new ArrayIterator().forEachRemaining(list::add);
        return list;
    }
